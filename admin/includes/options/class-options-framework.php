...
/**
 * @package Promociones_TAP_Options_Framework
 *
 */
class Promociones_TAP_Options_Framework {
    private $options;
...
//        require_once dirname( __FILE__ ) . '/options-sanitize.php';
        ...
        $this->options_sanitize = Promociones_TAP_Options_Sanitize::get_instance();
    }
    ...
    function optionsframework_init() {
        ...
        // Include the required files
        $this->options_interface = Promociones_TAP_Options_Interface::get_instance();
        $this->options_medida_uploader = Promociones_TAP_Options_Media_Uploader::get_instance();
        $this->options = Promociones_TAP_Options::get_instance();
        ...
        if ( isset( $optionsframework_settings['id'] ) ) {
            ...
            $option_name = 'promociones_tap_options_framework';
        }
        ...
        register_setting( 'promociones_tap_options_framework', $option_name, array($this, 'optionsframework_validate') );
    ...
    function optionsframework_add_page() {
        $this->of_screen_hook_suffix = add_submenu_page(
            $this->plugin_slug,
            __('Promociones  TAP &raquo; Settings', 'options_framework'),
            __('Settings', 'options_framework'),
    ...
    function optionsframework_load_styles() {
        wp_enqueue_style( 'options_framework', PROMOCIONES_TAP_OPTIONS_FRAMEWORK_DIRECTORY.'css/optionsframework.css' );
        if ( !wp_style_is( 'wp-color-picker','registered' ) ) {
            wp_register_style( 'wp-color-picker', PROMOCIONES_TAP_OPTIONS_FRAMEWORK_DIRECTORY.'css/color-picker.min.css' );
        }
...
//            return;
        ...
        if ( !wp_script_is( 'wp-color-picker', 'registered' ) ) {
            wp_register_script( 'of-iris', PROMOCIONES_TAP_OPTIONS_FRAMEWORK_DIRECTORY . 'js/iris.min.js', array( 'jquery-ui-draggable', 'jquery-ui-slider', 'jquery-touch-punch' ), false, 1 );
            wp_register_script( 'of-wp-color-picker', PROMOCIONES_TAP_OPTIONS_FRAMEWORK_DIRECTORY . 'js/color-picker.min.js', array( 'jquery', 'iris' ) );
        ...
        wp_enqueue_script( 'of-options-custom', PROMOCIONES_TAP_OPTIONS_FRAMEWORK_DIRECTORY . 'js/options-custom.js', array( 'jquery','wp-color-picker' ) );
...
//        add_action('admin_head', array($this->options, 'optionsframework_custom_scripts') );
            ...
            <div id="optionsframework-metabox" class="metabox-holder">
                <div id="optionsframework" class="postbox">
                    <form action="options.php" method="post">
                        <?php settings_fields( 'promociones_tap_options_framework' ); ?>
    ...
    function optionsframework_validate( $input ) {
        ...
        if ( isset( $_POST['reset'] ) ) {
            ...
            return $this->of_get_default_values();
        }
    ...
    function optionsframework_adminbar() {
        ...
        $wp_admin_bar->add_menu( array(
                ...
                'href' => admin_url( 'admin.php?page='.$this->plugin_slug.'/settings' )
            ));
    ...
    function of_get_option( $name, $default = false ) {
        $config = get_option( 'promociones_tap_options_framework' );
