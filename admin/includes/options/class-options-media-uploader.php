...
class Promociones_TAP_Options_Media_Uploader{
    /**
    ...
    public function optionsframework_media_scripts(){
        wp_enqueue_media();
        wp_register_script( 'of-media-uploader', PROMOCIONES_TAP_OPTIONS_FRAMEWORK_DIRECTORY .'js/media-uploader.js', array( 'jquery' ) );
