...
class Promociones_TAP_Options_Interface{
    /**
    ...
    function optionsframework_tabs() {
        $counter = 0;
        $options = Promociones_TAP_Options::get_instance()->optionsframework_options();
        $menu = '';
    ...
    function optionsframework_fields() {
        ...
        $options =& Promociones_TAP_Options_Framework::get_instance()->_optionsframework_options();
        ...
        foreach ( $options as $value ) {
            ...
            switch ( $value['type'] ) {
                ...
                // Uploader
                case "upload":
                    $output .= Promociones_TAP_Options_Media_Uploader::get_instance()->optionsframework_uploader( $value['id'], $val, null );
                ...
                case 'typography':
                    ...
                    $typography_options = array(
                        'sizes' => Promociones_TAP_Options_Sanitize::get_instance()->of_recognized_font_sizes(),
                        'faces' => Promociones_TAP_Options_Sanitize::get_instance()->of_recognized_font_faces(),
                        'styles' => Promociones_TAP_Options_Sanitize::get_instance()->of_recognized_font_styles(),
                        'color' => true
                    );
                ...
                case 'background':
                    ...
                    $repeats = Promociones_TAP_Options_Sanitize::get_instance()->of_recognized_background_repeat();
                    ...
                    $positions = Promociones_TAP_Options_Sanitize::get_instance()->of_recognized_background_position();
                    ...
                    $attachments = Promociones_TAP_Options_Sanitize::get_instance()->of_recognized_background_attachment();
